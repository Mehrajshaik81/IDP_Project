...
using Microsoft.AspNetCore.Mvc.Rendering; // For SelectListAdd commentMore actions
using TFMS.Data;
using TFMS.Models;
using TFMS.Services;
using System.Linq;
    ...
    public class VehiclesController : Controller
    {
        ...
        public async Task<IActionResult> Index(string? searchString, string? statusFilter, string? fuelTypeFilter)
        {
            ...
            ViewBag.FuelTypeFilter = new SelectList(
                allVehiclesForFilters.Select(v => v.FuelType).Distinct().Prepend("All").ToList(), // Add "All" optionAdd commentMore actions
