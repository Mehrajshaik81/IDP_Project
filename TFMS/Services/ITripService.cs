...
// Assuming your DbContext is here
...
namespace TFMS.Services
{
    ...
    public interface ITripService
    {
        ...
        Task<int> GetTripsCountByStatusAsync(TripStatus status);
        Task<List<Trip>> GetRecentTripsAsync(int count);

        // NEW: Method to get trips for a specific driver
        Task<IEnumerable<Trip>> GetTripsByDriverIdAsync(string driverId);

        Task<List<VehicleUtilizationDto>> GetVehicleUtilizationDataAsync();
